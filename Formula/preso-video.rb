...
class PresoVideo < Formula
  ...
  if OS.mac?
    url "https://github.com/camjjack/preso/releases/download/v0.2.2/preso-v0.2.2-aarch64-apple-darwin-video.tar.gz"
    sha256 "8016c1ccf6e212bbe7330f275506861613be1defce950a7f9e73c4d17453f1d1"

    depends_on arch: :arm64
  end

  if OS.linux?
    url "https://github.com/camjjack/preso/releases/download/v0.2.2/preso-v0.2.2-x86_64-unknown-linux-gnu-video.tar.gz"
    sha256 "c08456fd6833f4fc1281f07fb3b590eaadb59a394e250cca1fce018ce4bba600"
